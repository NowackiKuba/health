...
const HospitalReferall = forwardRef(({ props }: Props, ref: any) => {
  return (
    <div className='flex flex-col py-8 px-20 max-h-screen overflow-y-auto items-center justify-center gap-1 w-full text-black bg-white'>
      <div className='flex  border border-black w-full flex-col items-start justify-start'>
        ...
        <div className='flex items-center w-full'>
          <div className='border border-black border-l-0 w-1/2 p-1'>
            <p className='text-sm'>Date of referral: </p>
          </div>
          <div className='border border-black border-r-0 border-l-0 w-1/2 p-1'>
            <p className='text-sm'>Referring hospital: </p>
          </div>
        </div>
        <div className='flex items-center w-full'>
        ...
        <div className='flex items-center w-full'>
          <div className='border border-black border-t-0 border-l-0 w-1/2 p-1'>
            <p className='text-sm'>Doctor&apos; mobile number: </p>
          </div>
          <div className='border border-black border-r-0 border-t-0 border-l-0 w-1/2 p-1'>
        ...
        <div className='flex items-center w-full'>
          <div className='border border-black border-t-0 border-l-0 w-1/2 p-1'>
            <p className='text-sm'>Doctor&apos;s email: </p>
          </div>
          <div className='border border-black border-r-0 border-t-0 border-l-0 w-1/2 p-1'>
      ...
      <div className='flex  border border-black w-full flex-col items-start justify-start'>
        ...
        <div className='flex items-center w-full text-sm'>
          <div className='border p-1 border-black w-full'>
            <p className='font-semibold'>Act Classification</p>
          </div>
        ...
        <div className='flex items-center w-full text-sm'>
          <div className='border p-1 border-black w-full'>
            <p className='font-semibold'>Stage of Disease</p>
          </div>
